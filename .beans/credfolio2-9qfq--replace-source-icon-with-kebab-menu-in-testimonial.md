...
- [x] Review kebab menu implementation in WorkExperience/Education components
- [x] Extract shared menu component if not already abstracted (Decided not to - each section has its own simple ActionMenu with different actions that match their needs)
- [x] Replace source icon with kebab menu in TestimonialsSection
- [x] Ensure consistent styling and positioning
- [x] Add "View source document" action that opens the reference letter
